...
export function FeatureCard({
    ...
    return (
        ...
        >
            {/* Card */}
            <div className="relative h-full p-6 md:p-8 rounded-3xl bg-card border border-border/50 overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5">

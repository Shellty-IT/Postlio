...
/**
 * Modal do edycji/przycinania obrazu
 */
...
const ASPECT_RATIOS: Record<string, AspectRatioOption> = {
    ...
    landscape: {
        ...
        description: 'Facebook, LinkedIn, YouTube',
    },
    portrait: {
        label: '4:5',
        value: 4 / 5,
...
// ============================================================
// HELPER: Generowanie cropped image
// ============================================================
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[90vh] p-0 overflow-hidden">
                <DialogHeader className="p-6 pb-0">
                    <DialogTitle>Edytuj obraz</DialogTitle>
                    <DialogDescription>
                        Dostosuj kadr, zoom i proporcje obrazu dla różnych platform
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 p-6">
                    ...
                    {/* Right Panel - Aspect Ratios & Preview */}
                    <div className="space-y-4">
                        {/* Aspect Ratio Selection */}
                        <div className="space-y-2">
                            <Label className="text-sm font-medium">Proporcje</Label>
